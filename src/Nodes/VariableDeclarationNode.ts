...
export class VariableDeclarationNode extends DeclarationNode
{
    ...
    constructor(variableName: string, variableType: string, public readonly isExport: boolean, public readonly isConst: boolean, parent: DeclarationNode | null, command: vscode.Command, start: vscode.Position, end: vscode.Position)
    {
        super();
